...
// ternary operator 
// PYTHON: (DO THIS IF TRUE) if CONDITION else ( DO THIS IF FLASE )
...
//while loop 
//syntax : while (condition) { codeeblock };
const countUpTo =  num => {
    let i = 0;
    while (i< num) {
        console.log(i);
...
// DO while = will always occur once, even if condition is not met
...
//splice , kind of like .pop()

const output = arrNames.splice(1)
